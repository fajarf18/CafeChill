  ...
  <div class="container">
	<div class="row d-flex align-items-center">
		<div class="col-lg-6 hero-left">
		    <h1 class="display-4 mb-5">Experience Love At First Taste</h1>
		    <div class="mb-2">
		    	<a class="btn btn-primary btn-shadow btn-lg" href="menu.php" role="button">Main Menu</a>
<a class="btn btn-primary btn-shadow btn-lg" href="order.php" role="button">Order Now</a>
		    </div>
	    ...
	    <div class="col-lg-6 hero-right">
	    	<div class="owl-carousel owl-theme hero-carousel">
			    ...
			    <div class="item">
			    	<img class="img-fluid" src="img/cakecaffee.jpg" alt="">
			    </div>
			</div>
	    </div>
	</div>
         ...
         <div class="row">
         	<div class="col-lg-4">
         		<div class="footer-widget pr-lg-5 pr-0">
         			<img src="img/.png" class="img-fluid footer-logo mb-3" alt="">
